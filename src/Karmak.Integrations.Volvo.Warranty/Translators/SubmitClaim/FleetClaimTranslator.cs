...
{
    public class FleetClaimTranslator : SubmitClaimJobTranslator
    {
        public FleetClaimTranslator() { }
        ...
        public override JobExtended Translate(SubmitClaimJobTranslatorArguments args)
        {
            ...
            return new JobExtended
            {
                ...
                FleetApprovedAmount = Conversions.MoneyToAmountType(dealerRegionCurrency).Convert(claim.FleetAccount?.ApprovedAmount),
                ...
                ServiceParts = job?.PartExpenses?
                    .Select(MapServiceParts(claim, Conversions.DecimalToAmountType(dealerRegionCurrency), true))
                    .ToArray(),
